...
namespace PaginaGrupo.WebApp.Extensiones
{
    public class AutenticacionExtension : AuthenticationStateProvider
    {
        ...
        public async Task ActualizarEstadoAutenticacion(UsuarioSinClaveTokenDto? sesionUsuario)
        {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            var sesionUsuario = await _localStorage.GetItemAsync<UsuarioSinClaveTokenDto>("sesionUsuario");
